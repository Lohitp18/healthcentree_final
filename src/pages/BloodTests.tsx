      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div>
          <h1 className="text-4xl font-bold text-teal-800 mb-3">
            ALVA'S AESTHETIC REJUVENATION CENTRE
          </h1>
          <p className="text-lg text-slate-700">
            Welcome to Alva's Aesthetic Rejuvenation Centre, where beauty meets
            science in a sanctuary of rejuvenation and transformation.
          </p>
        </div>

        {/* Philosophy */}
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-teal-700">Our Philosophy</h2>
          <p>
            Step into our sleek and modern facility, where skilled professionals
            enhance your natural beauty and restore your youthful glow. From
            skincare treatments to advanced procedures, we combine technology
            and personalized care.
          </p>  
          <p>
            Our spa-like atmosphere offers a serene experience with luxurious
            services that melt stress and elevate confidence.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {[
              ...
              >
                <h3 className="font-semibold text-teal-800 mb-1">{service}</h3>
                <p className="text-sm">
                  {(() => {
                    switch (service) {
        ...
        <section>
          ...
          <ul className="space-y-4">
            <li>
              <strong>FMC (Fellowship in Medical Cosmetology):</strong> 6 months
              online + 10 days hands-on training. <br />
              <em>Eligibility: MBBS, BAMS, BHMS, BNYS, BDS</em>
            </li>
            <li>
              <strong>FAM (Fellowship in Aesthetic Medicine):</strong> 6 months
              online + 10 days hands-on training. <br />
              <em>Eligibility: MBBS, BAMS, BHMS, BNYS, BDS</em>
            </li>
            <li>
              <strong>PGDC (Post Graduate Diploma in Cosmetology):</strong> 3
              months online + 10 days hands-on training. <br />
              <em>Eligibility: MBBS, BAMS, BHMS, BNYS, BDS</em>
            </li>
            <li>
              <strong>Certificate Course in Cosmetology (For Beauticians):</strong>{" "}
              1 month online + 10 days hands-on training. <br />
        ...
        {/* Contact */}
        <section className="bg-teal-50 p-6 rounded-xl border border-teal-100 shadow-sm">
          <h2 className="text-2xl font-semibold text-teal-700 mb-2">Contact</h2>
          <p>
            <strong>Call Us:</strong> 9379525826 / 988290454 / 9481974422
            <br />
            <strong>Visit Us:</strong> Alvas Hospital Road, Mudbidri, Karnataka, India
            <br />
            <strong>WhatsApp:</strong> +91 9731336925
            <br />
